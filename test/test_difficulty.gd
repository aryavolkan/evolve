...
func _test_difficulty_factor_capped_above_max() -> void:
	...
	assert_approx(get_difficulty_factor(1000.0), 1.0, 0.001, "Factor above 500 should be capped at 1.0")
	assert_approx(get_difficulty_factor(9999.0), 1.0, 0.001, "Factor at very high score should be capped at 1.0")
...
func _test_enemy_speed_at_zero_score() -> void:
	assert_approx(get_scaled_enemy_speed(0.0), BASE_ENEMY_SPEED, 0.001, "Speed at score 0 should be base speed (150)")


func _test_enemy_speed_at_max_score() -> void:
	assert_approx(get_scaled_enemy_speed(500.0), MAX_ENEMY_SPEED, 0.001, "Speed at score 500 should be max speed (300)")
...
func _test_enemy_speed_at_mid_score() -> void:
	...
	assert_approx(get_scaled_enemy_speed(250.0), expected, 0.001, "Speed at score 250 should be 225")
...
func _test_spawn_interval_at_zero_score() -> void:
	assert_approx(get_scaled_spawn_interval(0.0), BASE_SPAWN_INTERVAL, 0.001, "Interval at score 0 should be base interval (50)")


func _test_spawn_interval_at_max_score() -> void:
	assert_approx(get_scaled_spawn_interval(500.0), MIN_SPAWN_INTERVAL, 0.001, "Interval at score 500 should be min interval (20)")
...
func _test_spawn_interval_at_mid_score() -> void:
	...
	assert_approx(get_scaled_spawn_interval(250.0), expected, 0.001, "Interval at score 250 should be 35")
