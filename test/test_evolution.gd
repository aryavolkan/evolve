...
func _run_tests() -> void:
	...
	_test("tournament_selection_prefers_higher_fitness", _test_tournament_selection_prefers_higher_fitness)
...
func _test_tournament_selection_prefers_higher_fitness() -> void:
	...
	assert_gt(avg_selected_fitness, population_avg_fitness, "Tournament selection should prefer higher fitness")
...
func _test_backup_and_restore_works() -> void:
	...
	for i in original_weights.size():
		assert_approx(restored_weights[i], original_weights[i], 0.0001, "Weight %d should be restored" % i)
...
func _test_save_load_population_roundtrip() -> void:
	...
	assert_approx(evo2.all_time_best_fitness, evo1.all_time_best_fitness, 0.001, "All-time best should match")
