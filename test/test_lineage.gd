...
func _run_tests() -> void:
	...
	_test("record_seed_assigns_ids", func():
		var tracker = TrackerScript.new()
	...
	_test("record_birth_increments_id", func():
		var tracker = TrackerScript.new()
	...
	_test("record_birth_stores_parents", func():
		var tracker = TrackerScript.new()
	...
	_test("update_fitness_modifies_record", func():
		var tracker = TrackerScript.new()
		var ids = tracker.record_seed(0, 3)
	...
	_test("get_ancestry_traces_parents", func():
		var tracker = TrackerScript.new()
		# Gen 0: seeds
	...
	_test("get_ancestry_handles_crossover", func():
		var tracker = TrackerScript.new()
	...
	_test("get_ancestry_respects_depth", func():
		var tracker = TrackerScript.new()
	...
	_test("prune_old_removes_generations", func():
		var tracker = TrackerScript.new()
	...
	_test("get_best_id_returns_highest_fitness", func():
		var tracker = TrackerScript.new()
