...
func _test_agent_scene_loads() -> void:
	var AgentScript = load("res://agent.gd")
	assert_not_null(AgentScript, "agent.gd should load")


func _test_agent_initial_state() -> void:
	var AgentScript = load("res://agent.gd")
	assert_not_null(AgentScript, "Agent script should be valid")


func _test_agent_reset() -> void:
	var AgentScript = load("res://agent.gd")
	assert_not_null(AgentScript, "Agent script should load for reset test")


func _test_agent_powerups() -> void:
	var AgentScript = load("res://agent.gd")
	assert_not_null(AgentScript, "Agent script should have powerup methods")
