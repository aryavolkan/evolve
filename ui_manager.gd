...
func setup_ui_screens() -> void:
	...
	main_game.get_node("CanvasLayer/UI").add_child(main_game.game_over_screen)
	...
	main_game.get_node("CanvasLayer/UI").add_child(main_game.sandbox_panel)
	...
	main_game.get_node("CanvasLayer/UI").add_child(main_game.comparison_panel)
	...
	main_game.get_node("CanvasLayer/UI").add_child(main_game.network_visualizer)
	...
	main_game.get_node("CanvasLayer/UI").add_child(main_game.educational_overlay)
	...
	main_game.get_node("CanvasLayer/UI").add_child(main_game.phylogenetic_tree)
